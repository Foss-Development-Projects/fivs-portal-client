            ...
            <div className="p-8 bg-blue-50 dark:bg-blue-900/10 rounded-[2.5rem] border border-blue-100 dark:border-blue-900/30 flex items-start space-x-6 max-w-2xl">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm font-medium text-blue-800 dark:text-blue-300 leading-relaxed">
                        Updating your email or password will not log you out of your current session. Ensure you are using a strong, unique password for your administrative account.
                    </p>
                </div>
            </div>
        </div>
